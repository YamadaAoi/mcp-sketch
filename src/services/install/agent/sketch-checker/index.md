...
| sketch-split-check      | 审核组件拆分结果，包括路径和合理性 | `page_name`, `artboard_name`, `split_result`, `preview_path` |
...
| sketch-screenshot-check | 截图比对设计稿与浏览器渲染效果     | `url`, `page_name`, `artboard_name`                          |
