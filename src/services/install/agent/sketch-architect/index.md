...
| Skill                  | 职责                                      | 必需参数                                                    | 可选参数       |
| ---------------------- | ----------------------------------------- | ----------------------------------------------------------- | -------------- |
| sketch-init            | 扫描项目生成 proj-init.md                 | —                                                           | `requirements` |
| sketch-init-components | 分析项目组件生态，生成 components-init.md | —                                                           |                |
...
| 当前 Skill             | NEXT_STEP                                                                                                             |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------- |
| sketch-init            | 委托subagent：sketch-architect 调用skill：sketch-init-components                                                      |
| sketch-init-components | 委托subagent：sketch-checker 调用skill：sketch-init-check                                                             |
